...
void command_set(Client *c, const Seperator *sep)
{
	...
	std::vector<Cmd> commands = {
		...
		Cmd{.cmd = "hero_model", .u = "hero_model [Hero Model] [Slot] (Slot is optional)", .fn = SetHeroModel, .a = {fmt::format("{}heromodel", EQ::constants::StaticLookup(c->ClientVersion())->SayLinkCommandToken)}},
