...
#include "../common/repositories/items_global_item_id_repository.h"
...
#include "repositories/items_global_item_id_repository.h"
...
{
	ItemsGlobalItemIdRepository::Truncate(*this);

	auto e = ItemsGlobalItemIdRepository::NewEntity();
	e.next_number = 1;

	ItemsGlobalItemIdRepository::InsertOne(*this, e);
}

uint64 Database::GetNextGlobalItemIdLimit()
{
	return ItemsGlobalItemIdRepository::GetNextSerialNumberRange(*this);
}